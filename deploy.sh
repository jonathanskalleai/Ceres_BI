...
export CERESBI_BI_DATABASE_URL_SECRET CERESBI_BI_JWT_SECRET CERESBI_BI_REFRESH_DATABASE_URL_SECRET CERESBI_BI_DATABASE_POOL_MIN CERESBI_BI_DATABASE_POOL_MAX CERESBI_BI_POOL_WAIT_TIMEOUT_MS CERESBI_BI_STATEMENT_TIMEOUT_MS CERESBI_BI_LOCK_TIMEOUT_MS CERESBI_BI_CACHE_TTL_SECONDS CERESBI_BI_CACHE_MAX_ITEMS CERESBI_BI_CACHE_MAX_ENTRY_BYTES CERESBI_BI_CORS_ORIGINS
