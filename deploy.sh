...
export CERESBI_BI_DATABASE_URL CERESBI_BI_DATABASE_POOL_MIN CERESBI_BI_DATABASE_POOL_MAX CERESBI_BI_STATEMENT_TIMEOUT_MS CERESBI_BI_LOCK_TIMEOUT_MS CERESBI_BI_CACHE_TTL_SECONDS CERESBI_BI_CACHE_MAX_ITEMS CERESBI_BI_CORS_ORIGINS
