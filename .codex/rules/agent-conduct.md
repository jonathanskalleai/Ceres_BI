...
> NOTA RUNTIME CODEX: ao contrario do Claude Code, o Codex NAO executa hooks.
> As secoes abaixo (protecao contra delecao, tamanho de componente, `any`) sao
> reforcadas no Claude Code por hooks deterministicos (`delete-guard.sh`,
> `quality-guard.sh`), mas no Codex valem como regra COMPORTAMENTAL absoluta —
> na duvida sobre deletar/sobrescrever, PERGUNTE antes; nao ha rede de seguranca.
