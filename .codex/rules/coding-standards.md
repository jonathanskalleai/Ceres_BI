...
**Aplicar:**
- **Meta ideal: <200 linhas** para codigo novo; **aviso em 300 linhas** (zona de
  risco — planejar quebra ja); **gate obrigatorio (HARD): 400 linhas** por
  arquivo/componente (incluindo imports).
  Ultrapassar 400 = FAIL no `@reviewer`/`@qa`. Sem excecoes silenciosas.
- Se aproximar de 300, quebrar em sub-componentes/hooks/utils ANTES de entregar
...
- [ ] Componentes <=400 linhas (HARD gate, FAIL acima); >300 = aviso; meta <200 para codigo novo
