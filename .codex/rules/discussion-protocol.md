...
Router coleta a opiniao de cada agente participante. No Codex, o fallback
oficial e executar sequencialmente no modelo atual da sessao; se o ambiente
oferecer subagentes/paralelismo, pode usar isso como otimizacao, sem depender
de troca de modelo.

```
@analyst:
  Leia `.codex/agents/analyst.md`.
...
Mesma estrutura para @pm, @architect, @ux e @data-engineer quando aplicavel.
