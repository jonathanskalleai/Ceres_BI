...
> **Perfil:** agente de planejamento/analise. Modelo: sessao Codex atual.
> Ao ser ativado diretamente, anunciar: `▶ [CODEX] @architect ativo`
...
No Codex, @architect usa o modelo atual da sessao. Para design profundo, explicite trade-offs, riscos e alternativas sem tentar trocar modelo por agente.
...
|---------|---------------------|
| #4 Componentes <300 linhas (HARD) / <200 meta | Definir granularidade dos componentes desde o inicio |
...
- Identificar violacoes (any, dead code, componentes >300 linhas, etc.)
