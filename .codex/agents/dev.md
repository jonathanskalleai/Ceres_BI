...
> Ao ser ativado diretamente, anunciar: `▶ [CODEX] @dev ativo`
...
definidas em `.codex/rules/coding-standards.md`.
...
No Codex, @dev usa o modelo atual da sessao. Para implementacoes muito complexas, aumente a profundidade do plano e valide com mais cuidado, sem tentar trocar modelo por agente.
...
3. **Planejar** estrutura — arquivos <300 linhas HARD (#4); se algo vai passar, ja desenhar a quebra ANTES de codar
...
- [ ] **#4 Componentes:** todos <=400 linhas (HARD gate — @reviewer/@qa dao FAIL acima); >300 = aviso; meta <200 para codigo novo
