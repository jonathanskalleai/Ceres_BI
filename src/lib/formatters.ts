...
/** Format days */
export function fmtDias(value: number | null | undefined): string {
  if (value == null || !Number.isFinite(value)) return "—";
 ...
 */
export function fmtBRLKpi(value: number | null | undefined): string {
  if (value == null || !Number.isFinite(value)) return "—";
...
export function isEmpty(v: number | null | undefined): boolean {
