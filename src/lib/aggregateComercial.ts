...
import type { VendedorPipeline } from "@/services/pipelineByVendedorService";
...
export function aggregate(registros: Registro[], pipelineMap?: Map<string, VendedorPipeline>): DadosComerciais {
