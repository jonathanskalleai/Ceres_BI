...
export function SvgBarH({
  ...
  // Gradient IDs: stable per component instance, scoped by data.length + index
  // Using a stable prefix avoids cross-render ID collisions.
  const gradIds = data.map((_, i) => `svgbarh-${width}-${i}`);
