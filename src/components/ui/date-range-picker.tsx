...
function getPresets(): Preset[] {
  ...
  return [
    ...
    { label: "Mês passado", range: { from: startOfMonth(lastMonth), to: endOfMonth(lastMonth) } },
    { label: "Últimos 30 dias", range: { from: subMonths(today, 1), to: today } },
    ...
    { label: "Todo o período", range: undefined },
  ];
}
