-- Migration: Ajuste de prioridade de filtros de data para o Dashboard de Desempenho de Vendas
-- Data: 2026-09-08
-- Descrição: Garante que p_from e p_to tenham precedência para filtragem temporal (mensal ou personalizada),
--            enquanto p_ano / v_target_year é mantido para alimentar a série mensal anual de 12 meses (gráfico de linhas).
