-------------------------------------------------------------------------------
-- rpc_acoes_bi v6  (supersede 20260727_rpc_acoes_bi_v5.sql)
--
-- MUDANCAS EM RELACAO A v5
--
-- 1) REMOCAO DO FILTRO DE FUNIS COMERCIAIS NA CTE pedidos_periodo
--    Ate a v5: pedidos_periodo filtrava por `nd.ngo_funil = ANY (c_funis_comerciais)`,
...
--
--    SOLUCAO v6: remover completamente o filtro de funil comercial da CTE
--    pedidos_periodo. Agora TODOS os pedidos aprovados no periodo sao
--    contabilizados, independente do funil em que o negocio esta alocado.
--
-- 2) REMOCAO DA CONSTANTE c_funis_comerciais
--    A constante `c_funis_comerciais` (linha 96 da v5) foi removida porque
...
--
-- RATIONALE:
--    O comentario original da v4/v5 sobre "Ganho em nao-comerciais nao e venda"
...
--
-- CTE ALTERADA: pedidos_periodo (filtro de funil removido)
-- CTE INALTERADA: filtered, negocios_dedup, negocios_tocados (mantem filtro
--   comercial para oportunidades), pedidos_dedup, valores_status, kpi_agg,
...
BEGIN
  ...
  -- ---------------------------------------------------------------------------
  -- CTE ALTERADA v6: pedidos_periodo
  --
  -- PEDIDOS APROVADOS NO PERIODO — TODOS, SEM FILTRO DE FUNIL.
  --
  -- v5 (INCORRETO): filtrava por `nd.ngo_funil = ANY (c_funis_comerciais)`,
  -- excluindo pedidos aprovados em BANCOS, OFICINA, MARKETING, ADM.
  --
  -- v6 (CORRIGIDO): remove filtro de funil. Cliente validou que 11 de 13
